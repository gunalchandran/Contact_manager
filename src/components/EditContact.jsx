...
import './styles/View.css'; // Ensure your CSS isn't hiding buttons
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Address</th>
                            <th>DOB</th>
                            <th>Actions</th> {/* Ensure the Actions header exists */}
                        </tr>
                    </thead>
                    <tbody>
                        {filteredContacts.map(contact => (
                            <tr key={contact._id}>
                                ...
                                <td>
                                    ...
                                    {/* Ensure the delete button is within the Actions column */}
